...
### Next (macOS 집중)
- [ ] MCP 인젝션 감지 — AgentLogParser 확장, Sentinel 핵심 차별점
- [ ] pyproject.toml 버전 업데이트 + watchdog 의존성 반영
- [ ] README 업데이트 — AI Security Layer 기능 문서화
...
- [x] Multi-channel notifications (macOS native + ntfy + Slack)
- [x] Critical-only alerting (warning/info log only)
- [ ] MCP 인젝션 감지 — Sentinel 핵심 차별점
- [ ] pyproject.toml 버전 업데이트 + watchdog 의존성
- [ ] README 업데이트 — AI Security Layer 문서화
- [ ] Cursor / VS Code Continue 로그 파서
